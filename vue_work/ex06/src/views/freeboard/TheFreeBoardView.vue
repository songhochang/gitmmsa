    ...
    <div>
        ...
        <div class="p-5">
            ...
            <div class="flex justify-between mt-5">
                ...
                hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300" @click="pageMove">수정</button>
                <button class="px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md
                hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300" @click="doDelete(idx)">삭제</button>
            </div>
        </div>
    </div>
</template>
...
const pageMove = ()=>{
    router.push({name:"freeboardinput", query:{idx}});
}
